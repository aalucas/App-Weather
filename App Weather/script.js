...
const API_KEY = "500750697edc4b2498a181040252207";
...
const displayHourlyForecast = (hourlyData) => {
    ...
    hourlyWeatherDiv.innerHTML = next24HoursData.map(item => {
        ...
        return `<li class="weather-item">
                    <p class="time">${time}</p>
                    <img src="./imgs/${weatherIcon}.svg" alt="" class="weather-icon">
...
const getWeatherDetails = async (API_URL) => {
    ...
    try{
        ...
        currentWeatherDiv.querySelector(".weather-icon").src = `./imgs/${weatherIcon}.svg`;
